    ...
    products_to_test.each_with_index do |tests, i|
      ...
      unless is_unavailable_online
        ...
        if @params['add_to_cart'] == true
          ...
          @browser.buy_as_guest_button.click if @params["login"] == ""
          @browser.wait_for_landing_page_load
          ...
          @browser.enter_billing_address_plus_email(@params["first_name"], @params["last_name"], @params["billing_line1"], @params["billing_city"], @params["billing_state"], @params["billing_zip"], @params["billing_phone"], @params["billing_email"])  if is_guest_user == true
          @browser.continue_checkout_button_handling.click
          @browser.wait_for_landing_page_load
          ...
          if is_guest_user == true
            @browser.store_pickup_zipcode_field.value = @params["billing_zip"]
          ...
          @browser.retry_until_found(lambda{@browser.chkout_store_pickup_number.exists != false})

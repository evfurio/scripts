#d-Con %QAAUTOMATION_SCRIPTS%\GameStopMobile\spec\GSmobile_functional_physical_invalid_gc_guest_user_spec.rb --csv %QAAUTOMATION_SCRIPTS%\GameStopMobile\Spec\MobileUI.csv --range "TFS47281" --browser chrome --or 
#
#
#######################################################################################################################################################################
###                                                Physical Product Purchase using Invalid GC  - Guest User                                                         ###          
#######################################################################################################################################################################
...
describe "GSMobile Functional Tests" do
  ...
  it "Physical Product Purchase using Invalid GC-Guest User " do
    @browser.open(@start_page)
   ...
   # @browser.product_list.at(0).name_link.click    
	...
	@browser.confirm_invalid_gc_warning

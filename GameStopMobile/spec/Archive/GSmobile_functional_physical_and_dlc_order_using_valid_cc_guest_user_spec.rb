#d-Con %QAAUTOMATION_SCRIPTS%\GameStopMobile\spec\GSmobile_functional_physical_and_dlc_order_using_valid_cc_guest_user_spec.rb --csv %QAAUTOMATION_SCRIPTS%\GameStopMobile\Spec\MobileUI.csv --range "TFS47267" --browser chrome --or 
#
#
#####################################################################################################################################################################
###                                            Physical and Digital Order Purchase  Using Valid CC - Guest                                                        ###          
#####################################################################################################################################################################
...
describe "GSMobile Functional Tests" do
  ...
  it "Physical and Digital Order Purchase  Using Valid CC-Guest" do
    @browser.open(@start_page)

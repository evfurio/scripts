#d-Con %QAAUTOMATION_SCRIPTS%\GameStopMobile\spec\GSmobile_functional_billship_address_mismatch_guest_user_spec.rb --csv %QAAUTOMATION_SCRIPTS%\GameStopMobile\Spec\MobileUI.csv --range "TFS47274" --browser chrome --or 
#
#
######################################################################################################################################################################
###                             Physical Product Purchase for BillShip Mismatch review Using Valid CC - Guest                                                      ###          
######################################################################################################################################################################
...
describe "GSMobile Functional Tests" do
  ...
  it "Physical Product Purchase for BillShip Mismatch review Using Valid CC-Guest" do
    @browser.open(@start_page)

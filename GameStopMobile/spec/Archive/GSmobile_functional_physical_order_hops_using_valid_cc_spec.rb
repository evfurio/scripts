#d-Con %QAAUTOMATION_SCRIPTS%\GameStopMobile\spec\GSmobile_functional_physical_order_hops_using_valid_cc_spec.rb --csv %QAAUTOMATION_SCRIPTS%\GameStopMobile\Spec\MobileUI.csv --range "TFS47510" --browser chrome --or 
#
#
###########################################################################################################################################################
###                                       Physical Product HOPS Purchase using Valid CC                                                                 ###          
###########################################################################################################################################################
...
describe "GSMobile Functional Tests" do
  ...
  it "Physical Product HOPS Purchase using Valid CC" do
    @browser.open(@start_page)

#d-Con %QAAUTOMATION_SCRIPTS%\GameStopMobile\spec\GSmobile_functional_verify_prod_desc_handling_page_spec.rb --csv %QAAUTOMATION_SCRIPTS%\GameStopMobile\Spec\MobileUI.csv --range "TFS47513" --browser chrome --or 
#
#
###########################################################################################################################################################
###                   Product description should show up when "Show Order Summary" link is Clicked on Handling Address Page                             ###          
###########################################################################################################################################################
...
describe "GSMobile Functional Tests" do
  ...
  it "Product description should show up when Show Order Summary link is Clicked on Handling Address Page" do
    @browser.open(@start_page)

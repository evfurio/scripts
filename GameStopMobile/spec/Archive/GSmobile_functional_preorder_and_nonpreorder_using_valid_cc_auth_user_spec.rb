#d-Con %QAAUTOMATION_SCRIPTS%\GameStopMobile\spec\GSmobile_functional_preorder_and_nonpreorder_using_valid_cc_auth_user_spec.rb --csv %QAAUTOMATION_SCRIPTS%\GameStopMobile\Spec\MobileUI.csv --range "TFS47420" --browser chrome --or 
#
#
########################################################################################################################################################################
###                                            Preorder and Non Preorder Purchase Using Valid CC - Authenticated User                                                ###          
########################################################################################################################################################################
...
describe "GSMobile Functional Tests" do
  ...
  it "Preorder and Non Preorder Purchase Using Valid CC - Authenticated User" do
    @browser.open(@start_page)

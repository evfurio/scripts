#d-Con %QAAUTOMATION_SCRIPTS%\GameStopMobile\spec\GSmobile_functional_preorder_and_dlc_using_valid_cc_auth_user_spec.rb --csv %QAAUTOMATION_SCRIPTS%\GameStopMobile\Spec\MobileUI.csv --range "TFS47421" --browser chrome --or 
#
#
################################################################################################################################################################
###                                 Preorder Product and DLC Purchase using Valid CC - Authenticated User                                                    ###          
################################################################################################################################################################
...
describe "GSMobile Functional Tests" do
  ...
  it "Preorder Product and DLC Purchase using Valid CC - Authenticated User" do
    @browser.open(@start_page)

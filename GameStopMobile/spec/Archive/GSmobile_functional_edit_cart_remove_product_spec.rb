#d-Con %QAAUTOMATION_SCRIPTS%\GameStopMobile\spec\GSmobile_functional_edit_cart_remove_product_spec.rb --csv %QAAUTOMATION_SCRIPTS%\GameStopMobile\Spec\MobileUI.csv --range "TFS47457" --browser chrome --or 
#
#
###########################################################################################################################################################
###                                       Remove Product from the Cart Holding Single Product - Guest User                                              ###          
###########################################################################################################################################################
...
describe "GSMobile Functional Tests" do
  ...
  it "Remove Product from the Cart Holding Single Product-Guest user" do
    @browser.open(@start_page)

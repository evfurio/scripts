#d-Con %QAAUTOMATION_SCRIPTS%\GameStopMobile\spec\GSmobile_functional_giftmsg_50_char_auth_user_spec.rb --csv %QAAUTOMATION_SCRIPTS%\GameStopMobile\Spec\MobileUI.csv --range "TFS47500" --browser chrome --or 
#
#
###########################################################################################################################################################
###                                  Optional Gift Message Field should Accept 50 Char - Auth User                                                      ###          
###########################################################################################################################################################
...
describe "GSMobile Functional Tests" do
  ...
  it "Optional Gift Message Field should Accept 50 Char-Auth User" do
    @browser.open(@start_page)
	...
	@browser.chkout_gift_message_field.value = "12345678901234567890123456789012345678901234567890"

#d-Con %QAAUTOMATION_SCRIPTS%\GameStopMobile\spec\GSmobile_functional_physical_employee_valid_cc_guest_user_spec.rb --csv %QAAUTOMATION_SCRIPTS%\GameStopMobile\Spec\MobileUI.csv --range "TFS47272" --browser chrome --or 
#
#
#####################################################################################################################################################################
###                                         Product Purchase as Employee Order using Valid CC - Guest                                                             ###          
#####################################################################################################################################################################
...
describe "GSMobile Functional Tests" do
  ...
  it "Product Purchase as Employee Order using Valid CC-Guest" do
    @browser.open(@start_page)

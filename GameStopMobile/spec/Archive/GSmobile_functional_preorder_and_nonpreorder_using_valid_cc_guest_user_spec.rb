#d-Con %QAAUTOMATION_SCRIPTS%\GameStopMobile\spec\GSmobile_functional_preorder_and_nonpreorder_using_valid_cc_guest_user_spec.rb --csv %QAAUTOMATION_SCRIPTS%\GameStopMobile\Spec\MobileUI.csv --range "TFS47268" --browser chrome --or 
#
#
########################################################################################################################################################################
###                                            Preorder and Non Preorder Purchase using Valid CC - Guest User                                                        ###          
########################################################################################################################################################################
...
describe "GSMobile Functional Tests" do
  ...
  it "Preorder and Non Preorder Purchase using Valid CC-Guest User" do
    @browser.open(@start_page)

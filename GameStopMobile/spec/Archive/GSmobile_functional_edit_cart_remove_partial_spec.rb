#d-Con %QAAUTOMATION_SCRIPTS%\GameStopMobile\spec\GSmobile_functional_edit_cart_remove_partial_spec.rb --csv %QAAUTOMATION_SCRIPTS%\GameStopMobile\Spec\MobileUI.csv --range "TFS47451" --browser chrome --or
#
#
#######################################################################################################################################################################
###                                        Remove one item from the cart holding multiple products - Guest User                                                     ###          
#######################################################################################################################################################################
...
describe "GSMobile Functional Tests" do
  ...
  it "Remove one item from the cart holding multiple products-Guest User" do

#d-Con %QAAUTOMATION_SCRIPTS%\GameStopMobile\spec\GSmobile_functional_dlc_order_using_valid_cc_guest_user_spec.rb --csv %QAAUTOMATION_SCRIPTS%\GameStopMobile\Spec\MobileUI.csv --range "TFS47261" --browser chrome --or
#
#
############################################################################################################################################################
###                                                 Digital Order purchase for using Valid CC                                                            ###          
############################################################################################################################################################
...
describe "GSMobile Functional Tests" do
  ...
  it "Digital Order purchase for using Valid CC" do
    @browser.open(@start_page)

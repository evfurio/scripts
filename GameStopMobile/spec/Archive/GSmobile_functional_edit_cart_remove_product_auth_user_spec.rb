#d-Con %QAAUTOMATION_SCRIPTS%\GameStopMobile\spec\GSmobile_functional_edit_cart_remove_product_auth_user_spec.rb --csv %QAAUTOMATION_SCRIPTS%\GameStopMobile\Spec\MobileUI.csv --range "TFS47463" --browser chrome --or
#
#
###########################################################################################################################################################
###                                       Remove Product from the Cart Holding Single Product - Auth User                                               ###          
###########################################################################################################################################################
...
describe "GSMobile Functional Tests" do
  ...
  it "Remove Product from the Cart Holding Single Product - Auth User" do
    @browser.open(@start_page)
	...
	@browser.remove_item_link.click

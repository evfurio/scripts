#d-Con %QAAUTOMATION_SCRIPTS%\GameStopMobile\spec\GSmobile_functional_physical_order_using_valid_cc_auth_user_address_in_profile_spec.rb --csv %QAAUTOMATION_SCRIPTS%\GameStopMobile\Spec\MobileUI.csv --range "TFS47662" --browser chrome --or 
#
#
#####################################################################################################################################################################################
###                                     Physical Product Purchase using Valid CC Address Stored in Profile  - Authenticated User                                                  ###          
#####################################################################################################################################################################################
...
describe "GSMobile Functional Tests" do
  ...
  it "Physical Product Purchase using Valid CC Address Stored in Profile - Auth User" do
    @browser.open(@start_page)

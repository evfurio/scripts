#d-Con %QAAUTOMATION_SCRIPTS%\GameStopMobile\spec\GSmobile_functional_change_address_link_on_payment_page_auth_user_spec.rb --csv %QAAUTOMATION_SCRIPTS%\GameStopMobile\Spec\MobileUI.csv --range "TFS47697" --browser chrome --or
#
#
###########################################################################################################################################################
###                                     Modify Address on Payment Page - Auth User  - Authenticated User                                                ###          
###########################################################################################################################################################
...
describe "GSMobile Functional Tests" do
  ...
  it "Modify Address on Payment Page - Auth User" do
    @browser.open(@start_page)

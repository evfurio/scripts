#d-Con %QAAUTOMATION_SCRIPTS%\GameStopMobile\spec\GSmobile_functional_physical_order_hops_using_invalid_cc_spec.rb --csv %QAAUTOMATION_SCRIPTS%\GameStopMobile\Spec\MobileUI.csv --range "TFS47511" --browser chrome --or 
#
#
###########################################################################################################################################################
###                                       Physical Product HOPS Purchase using Invalid CC                                                               ###          
###########################################################################################################################################################
...
describe "GSMobile Functional Tests" do
  ...
  it "Physical Product HOPS Purchase using Invalid CC" do
    @browser.open(@start_page)
	...
	@browser.confirm_cc_number_warning_hops

#d-Con %QAAUTOMATION_SCRIPTS%\GameStopMobile\spec\GSmobile_functional_giftmsg_under_50_char_guest_spec.rb --csv %QAAUTOMATION_SCRIPTS%\GameStopMobile\Spec\MobileUI.csv --range "TFS47502" --browser chrome --or 
#
#
###########################################################################################################################################################
###                                 Optional Gift Message Field should Accept under 50 - Guest User                                                     ###          
###########################################################################################################################################################
...
describe "GSMobile Functional Tests" do
  ...
  it "Optional Gift Message Field should Accept under 50-Guest User" do
    @browser.open(@start_page)
	...
	@browser.chkout_gift_message_field.value = "I am testing this box"

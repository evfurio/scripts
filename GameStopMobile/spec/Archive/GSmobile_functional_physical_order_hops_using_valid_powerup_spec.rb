#d-Con %QAAUTOMATION_SCRIPTS%\GameStopMobile\spec\GSmobile_functional_physical_order_hops_using_valid_powerup_spec.rb --csv %QAAUTOMATION_SCRIPTS%\GameStopMobile\Spec\MobileUI.csv --range "TFS47505" --browser chrome --or 
#
#
###########################################################################################################################################################
###                                    Physical Product HOPS Purchase using Valid PowerUp                                                               ###          
###########################################################################################################################################################
...
describe "GSMobile Functional Tests" do
  ...
  it "Physical Product HOPS Purchase using Valid PowerUp" do
    @browser.open(@start_page)
	...
	@browser.hops_order_confirm_label.should_exist

...
SELECT TOP 1000
   ...
   , a.i_address_type, a.u_first_name, a.u_last_name, a.u_address_line1, a.u_address_line2
...
SELECT TOP 1000 u.u_user_id, u.u_email_address, u.HomeStore
			  , a.i_address_type, a.u_address_name, a.u_last_name
FROM profile.Stage.Ecom_Addresses a
	JOIN profile.Stage.Ecom_UserObject u
		ON a.u_email_address = u.u_email_address

--or

WITH MultiAddrID_CTE (addr_id, userid, homestore)
	AS
	(
	SELECT TOP 1000 SUBSTRING(u.u_addresses, 3, 38) AS Addr_ID1, u.u_user_id, u.HomeStore
	FROM profile.stage.Ecom_UserObject u WITH(NOLOCK)
	...
	SELECT TOP 1000 SUBSTRING(u.u_addresses, 42, 38) AS Addr_ID2, u.u_user_id, u.HomeStore
	FROM profile.stage.Ecom_UserObject u WITH(NOLOCK)
		JOIN profile.stage.Ecom_Addresses a
	...
	SELECT TOP 1000 SUBSTRING(u.u_addresses, 81, 38) AS Addr_ID3, u.u_user_id, u.HomeStore
	FROM profile.stage.Ecom_UserObject u WITH(NOLOCK)
		JOIN profile.stage.Ecom_Addresses a
	...
	SELECT TOP 1000 SUBSTRING(u.u_addresses, 120, 38) AS Addr_ID1, u.u_user_id, u.HomeStore
	FROM profile.stage.Ecom_UserObject u WITH(NOLOCK)
		JOIN profile.stage.Ecom_Addresses a

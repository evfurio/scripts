...
SELECT p1.Name
	 ...
	 , wia.ID AS TC_ID_Nbr, wia.Title AS TC_Title, wia.State, wia.fld10048 AS Automation_Status
...
SELECT p2.Name
	 ...
	 , wia1.ID AS TC_ID_Nbr, wia1.Title AS TC_Title, wia1.State, wia1.fld10048 AS Automation_Status
...
SELECT p3.Name
	 ...
	 , wia2.ID AS TC_ID_Nbr, wia2.Title AS TC_Title, wia2.State, wia2.fld10048 AS Automation_Status
...
SELECT p4.Name
	 ...
	 , wia3.ID AS TC_ID_Nbr, wia3.Title AS TC_Title, wia3.State, wia3.fld10048 AS Automation_Status
...
SELECT p5.Name
	 ...
	 , wia4.ID AS TC_ID_Nbr, wia4.Title AS TC_Title, wia4.State, wia4.fld10048 AS Automation_Status
...
SELECT p6.Name
	 ...
	 , wia5.ID AS TC_ID_Nbr, wia5.Title AS TC_Title, wia5.State, wia5.fld10048 AS Automation_Status

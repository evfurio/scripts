...
## 
## d-con %QAAUTOMATION_SCRIPTS%\Utilities\generic_test_xml_generator.rb  --csv %QAAUTOMATION_SCRIPTS%\GameStop\spec\UI\GS\checkout_dataset.csv
##
...
class MakeGenTestXMLs
  ...
  def build_xml
    ...
    path = "#{ENV['QAAUTOMATION_SCRIPTS']}/Doc/gs_ui_wrappers"

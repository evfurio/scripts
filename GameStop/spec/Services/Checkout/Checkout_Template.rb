...
#Add products to cart
		...
		#create_purchase_order_data.targeting_context.content = nil
		...
		get_available_shipping_methods_req.find_tag("targeting_context").content = nil
...
##getting this from the database but haven't set this up for multiple products as of yet
        ...
        #validate_purchase_order_req.find_tag("targeting_context").content = nil
        ...
        validate_purchase_order_req.find_tag("session_id").at(0).content = @session_id  # oddly found in header
        validate_purchase_order_req.find_tag("owner_id").at(0).content = @owner_id 
		#validate_purchase_order_req.find_tag("targeting_context").at(0).content = nil

SELECT   TOP 1 D.variantid, D.taxabilitycode, d.esrbrating FROM [Gamestop_productcatalog].[dbo].[GameStopBase_en-US_Catalog] A WITH (NOLOCK) 
...
WHERE c.isavailable = 1 and c.variantid <> '0' and c.variantid <> '' AND d.searchable =1 AND i.onhandquantity > '900' AND c.condition != 'Digital' and c.condition != 'Download' AND

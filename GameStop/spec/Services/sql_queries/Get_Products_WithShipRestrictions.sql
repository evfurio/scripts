SELECT c.availability, c.isavailable, d.searchable, D.variantid AS SKU,D.ProductID AS PRODUCTID, i.skuvariantid, m.[variant.SKU], A.DisplayName AS DISPLAY_NAME, D.cy_list_price AS LIST_PRICE, i.OnHandQuantity, m.[variant.Availability], D.InternationalShippingRestrictions as ShipRestrictions

SELECT top 1 C.Availability, C.ProductID, D.variantid, D.taxabilitycode, d.esrbrating,
 i.onhandquantity, A.DisplayName as Title, C.Condition, c.isavailable, d.searchable,d.EnableUpsellRecommendations
...
AND d.searchable =1  AND c.condition != 'Digital' and c.condition != 'Download' AND
D.ProductLimit is NULL AND i.onhandquantity > '100' and D.variantid not in ('859996','859998', '859997')

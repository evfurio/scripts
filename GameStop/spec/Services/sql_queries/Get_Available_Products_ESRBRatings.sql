SELECT top 20 D.variantid AS SKU,D.ProductLimit, D.ESRBRating AS ESRB, D.ProductID AS PRODUCTID, A.DisplayName AS DISPLAY_NAME, D.cy_list_price AS LIST_PRICE, i.OnHandQuantity

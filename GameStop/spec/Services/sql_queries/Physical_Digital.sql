...
WHERE c.isavailable = 1
      ...
      AND d.condition in ('New', 'Digital')
...
--SELECT top 1 New, Digital
--FROM
(select Distinct top 1 variantId as variantid, TaxabilityCode as taxabilitycode, ProductID, ESRBRating, Condition
from CTE_GameStop where condition = 'New') --New
UNION ALL
(select Distinct top 1 VariantId as variantid, TaxabilityCode as taxabilitycode, ProductID, ESRBRating, Condition
from CTE_GameStop where condition = 'Digital') --Digital

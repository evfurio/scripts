SELECT top 1 D.variantid, A.DisplayName, D.esrbrating, d.condition, d.ProductID, d.InStorePickup,d.AllowInstorePickup
...
WHERE c.availability in ('PR') and c.isavailable = 1 and c.variantid <> '0' and c.variantid <> '' AND 
	...
	D.ProductLimit is NULL AND i.onhandquantity > '100' and d.instorepickup = 1 and D.variantid not in ('859996','859998', '859997')
ORDER BY NEWID()

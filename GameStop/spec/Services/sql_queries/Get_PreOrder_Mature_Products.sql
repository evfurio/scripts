SELECT top 3 D.variantid AS SKU, D.taxabilitycode, D.ESRBRating AS ESRB, D.ProductID AS PRODUCTID, A.DisplayName AS DISPLAY_NAME, D.cy_list_price AS LIST_PRICE, i.OnHandQuantity, d.productlimit, D.variantid, D.esrbrating

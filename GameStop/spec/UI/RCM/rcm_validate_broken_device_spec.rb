### *** Recommerce *** 
### d-Con %QAAUTOMATION_SCRIPTS%\GameStop\spec\UI\RCM\rcm_validate_broken_device_spec.rb --prop %QAAUTOMATION_SCRIPTS%\Common\config\properties.csv  --url QA_GS --csv %QAAUTOMATION_SCRIPTS%\GameStop\spec\UI\RCM\tradevalue_dataset.csv --range TFS40135 --browser chrome --or 

...
# d-Con %QAAUTOMATION_SCRIPTS%\GameStop\Spec\UI\GS\cart_sanity_spec.rb  --csv %QAAUTOMATION_SCRIPTS%\GameStop\Spec\UI\GS\checkout_dataset.csv --range TFS48627 --login qa_ui_testing1@qagsecomprod.oib.com --password T3sting --sql %QAAUTOMATION_SCRIPTS%\Common\sql_queries\get_ten_products.sql --browser chrome --or
...
describe "Cart Validation" do
  ...
  it "#{$tc_id} #{$tc_desc}" do
    ...
    @browser.powerup_rewards_number_field.value = "3876777784539"

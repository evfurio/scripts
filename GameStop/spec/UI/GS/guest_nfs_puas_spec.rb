#USAGE NOTES#
# d-Con %QAAUTOMATION_SCRIPTS%\GameStop\Spec\UI\GS\guest_nfs_puas_spec.rb --csv %QAAUTOMATION_SCRIPTS%\GameStop\Spec\UI\GS\checkout_dataset.csv --range TFS74567 --browser chrome --or 
...
describe "Guest NFS PUAS Button" do
  ...
  after(:all) do
    ...
    @browser.hops_zip_code_search_button.click
		...
		$tracer.report("Actual Event :: #{store_search_event}        Expected Event :: event33")

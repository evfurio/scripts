...
AND d.searchable =1  AND c.condition = 'New' AND
D.ProductLimit is NULL AND i.onhandquantity > '1' and D.variantid not in ('859996','859998', '859997')AND c.condition != 'Warranty'
AND (d.EnableUpsellRecommendations = '0' OR d.EnableUpsellRecommendations is NULL)
and d.InternationalShippingRestrictions = 'No Restriction'
ORDER BY newid()

--select distinct InternationalShippingRestrictions from [Gamestop_productcatalog].[dbo].[GameStopBase_CatalogProducts]
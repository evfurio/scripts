SELECT TOP 1 D.variantid,A.displayname AS TITLE, D.taxabilitycode, D.cy_list_price AS PRICE,d.EnableUpsellRecommendations
...
WHERE c.isavailable = 1 and c.variantid <> '' AND d.searchable =1 AND i.onhandquantity > '10' AND A.displayname like '%iPod%' AND D.cy_list_price > '200.00'

SELECT top 20 D.variantid AS SKU, D.ESRBRating AS ESRB,
 D.ProductID AS PRODUCTID, A.DisplayName AS DISPLAY_NAME,
  D.cy_list_price AS LIST_PRICE, i.OnHandQuantity, d.productlimit,d.EnableUpsellRecommendations
...
(SELECT y.ProductID , count(*) 'Variant Count' 
	...
	WHERE c.availability = 'PR' and c.variantid <> '0' and c.variantid <> '' 
		AND d.searchable =1 AND D.ESRBRating != 'M' and d.instorepickup = 0

SELECT top 20 D.variantid AS SKU,D.ProductID AS PRODUCTID, A.DisplayName AS DISPLAY_NAME, D.cy_list_price AS LIST_PRICE, i.OnHandQuantity, D.ProductLimit,d.EnableUpsellRecommendations
...
(SELECT y.ProductID , count(*) 'Variant Count' 
	...
	WHERE c.availability = 'A' and c.isavailable = 1 and c.variantid <> '0' and c.variantid <> '' 
		AND d.searchable =1 and D.productlimit is not NULL

SELECT top 20 D.variantid AS SKU,D.ProductID AS PRODUCTID, A.DisplayName AS DISPLAY_NAME, D.cy_list_price AS LIST_PRICE, i.OnHandQuantity, D.TaxabilityCode AS TaxCode,d.EnableUpsellRecommendations 
FROM [Gamestop_productcatalog].[dbo].[GameStopBase_fr-CA_Catalog] A WITH (NOLOCK)
	INNER JOIN 

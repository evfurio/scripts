SELECT  TOP 1 D.variantid AS variantid,A.displayname AS TITLE, D.cy_list_price AS PRICE,D.TaxabilityCode as taxabilitycode,d.EnableUpsellRecommendations

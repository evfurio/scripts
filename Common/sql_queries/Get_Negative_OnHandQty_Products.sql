...
A.DisplayName AS DISPLAY_NAME, D.cy_list_price AS LIST_PRICE, i.OnHandQuantity,d.EnableUpsellRecommendations
...
(SELECT y.ProductID , count(*) 'Variant Count' 
	...
	WHERE c.availability = 'BO' and c.isavailable = 1 and c.variantid <> '0' and c.variantid <> '' 
		AND d.searchable =1 and OnHandQuantity < 0

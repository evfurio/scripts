SELECT TOP 100 c.availability, c.isavailable, d.searchable, D.variantid AS SKU,D.ProductID AS PRODUCTID, i.skuvariantid, m.[variant.SKU], A.DisplayName AS DISPLAY_NAME, D.cy_list_price AS LIST_PRICE, i.OnHandQuantity, m.[variant.Availability],  d.EnableUpsellRecommendations
...
(SELECT y.ProductID , count(*) 'Variant Count' 
	...
	WHERE c.availability = 'A' and c.isavailable = 1 and c.variantid <> '0' and c.variantid <> '' 
		AND d.searchable =1 AND i.onhandquantity > '5' AND c.condition != 'Warranty'

...
CREATE_VENDOR_AGREEMENT_V3 = <<eos
<soap:Envelope xmlns:soap="http://www.w3.org/2003/05/soap-envelope" xmlns:pay="http://gamestop.com/paymentandfraud/v3/payment">
   <soap:Header/>
   <soap:Body>
...
GET_VENDOR_AGREEMENT_DETAILS_V3 = <<eos
<soap:Envelope xmlns:soap="http://www.w3.org/2003/05/soap-envelope" xmlns:pay="http://gamestop.com/paymentandfraud/v3/payment">
   <soap:Header/>
   <soap:Body>
...
INITIALIZE_PAYMENT_V3 = <<eos
<soap:Envelope xmlns:soap="http://www.w3.org/2003/05/soap-envelope" xmlns:pay="http://gamestop.com/paymentandfraud/v3/payment">
   <soap:Header/>
   <soap:Body>
      <pay:InitializePaymentRequest>
         <!--Optional:-->
         <pay:ClientChannel>?</pay:ClientChannel>
         <!--Optional:-->
         <pay:ElectronicAccount>
...
SAVE_PAYMENT_METHODS_WITH_ELECTRONIC_ACCOUNT_V3 = <<eos
<soap:Envelope xmlns:soap="http://www.w3.org/2003/05/soap-envelope" xmlns:pay="http://gamestop.com/paymentandfraud/v3/payment">
   <soap:Header xmlns:wsa="http://www.w3.org/2005/08/addressing">
        <wsa:Action soap:mustUnderstand="1">?</wsa:Action>
        <wsa:To soap:mustUnderstand="1">?</wsa:To>  
   ...
   <soap:Body>
      <pay:SavePaymentMethodsRequest>
         ...
         <pay:PaymentMethods>
            <!--Zero or more repetitions:-->
            <pay:PaymentMethod xsi:type="pay:ElectronicAccount" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
				 <pay:AccountType>?</pay:AccountType>
				 <pay:AgreementNumber>?</pay:AgreementNumber>
				 <pay:ClientPaymentMethodID>?</pay:ClientPaymentMethodID>
         </pay:PaymentMethods>
...
<soap:Envelope xmlns:soap="http://www.w3.org/2003/05/soap-envelope" xmlns:pay="http://gamestop.com/paymentandfraud/v3/payment">
   ...
   <soap:Body>
      <pay:SettleRequest>
         ...
         <pay:ReferenceNumber>?</pay:ReferenceNumber>
         <!--Optional:-->
         <pay:TransactionNumber>?</pay:TransactionNumber>
      </pay:SettleRequest>
   </soap:Body>
</soap:Envelope>
...
VALIDATE_VENDOR_AGREEMENT_V3 = <<eos
<soap:Envelope xmlns:soap="http://www.w3.org/2003/05/soap-envelope" xmlns:pay="http://gamestop.com/paymentandfraud/v3/payment">
   <soap:Header/>
   <soap:Body>

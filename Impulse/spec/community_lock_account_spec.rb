...
describe "Community - Lock Account Suite" do

   before(:all) do
    csv = QACSV.new(csv_filename_parameter)
    @row = csv.find_row_by_name(csv_range_parameter)
	
    @start_page = "http://www.impulsedriven.net"
    if os_name == "darwin"
  ...
  after(:all) do
   ...
   it "should verify login and then lockout an account from the Community Login page " do

...
describe "Impulse Checkout Suite" do
   ...
   before(:all) do
    @start_page = "http://dev1.www.impulsedriven.com"
    if os_name == "darwin"
  ...
  after(:all) do
   ...
   it "should create an account then buy a product using CC" do
	...
	@browser.url.should start_with "https://dev1.impulsestore"
    ...
    @browser.continue_button.click	
	@browser.url.should include "dev1.www."
...
.click
	...
	#Add a coupon
	@browser.coupon_field.value = "LLTT-QXKJ-GSSW"
